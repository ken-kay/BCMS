...
class _RecordState extends State<Record> {
  ...
  Details day=Details(DateTime.now());
                    ...
                    children: <Widget>[
                      Expanded(
                        child: RaisedButton(
                          ...
                          child: Column(
                            children: <Widget>[
                              Icon(day.h1?Icons.check_circle_outline:Icons.error_outline,
                              color: day.h1?Colors.blue:Colors.red[200],),
                              SizedBox(height: 12.0),
                              Text(
                                day.h1?'Present':'Absent'),
                            ]
                          ),
                          onPressed: (){
                            setState(() {
                      ...
                      Expanded(
                        child: RaisedButton(
                          ...
                          child: Column(
                            children:<Widget> [
                              Icon(day.h2?Icons.check_circle_outline:Icons.error_outline,
                              color: day.h2?Colors.blue:Colors.red[200],
                              ),
                              SizedBox(height: 12.0),
                      ...
                      Expanded(
                        child: RaisedButton(
                          ...
                          child: Column(
                            children: <Widget>[
                              Icon(day.h3?Icons.check_circle_outline:Icons.error_outline,
                              color:day.h3?Colors.blue:Colors.red[200],),
                              SizedBox(height: 12.0),
                    ...
                    children: <Widget>[
                      Expanded(
                        child: RaisedButton(
                          ...
                          child: Column(
                            children: <Widget>[
                              Icon(day.h4?Icons.check_circle_outline:Icons.error_outline,
                              color:day.h4?Colors.blue:Colors.red[200],
                              ),
                              SizedBox(height: 12.0),
                      ...
                      Expanded(
                        child: RaisedButton(
                          ...
                          child: Column(
                            children:<Widget> [
                              Icon(day.h5?Icons.check_circle_outline:Icons.error_outline,
                                color: day.h5?Colors.blue:Colors.red[200],
                              ),
                              SizedBox(height: 12.0),
                      ...
                      Expanded(
                        child:RaisedButton(
                          ...
                          child: Column(
                            children:<Widget> [
                              Icon(day.h6?Icons.check_circle_outline:Icons.error_outline,
                              color: day.h6?Colors.blue:Colors.red[200],),
                              SizedBox(height: 12.0),
